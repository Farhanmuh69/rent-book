...
<head>
    ...
    <link rel="stylesheet" href="{{asset('css/style.css')}}"><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
</head>
                ...
                <div class="sidebar col-lg-2 collapse d-lg-block" id="navbarTogglerDemo02">
                    {{-- @if (Auth::user()) --}}
                        @if (Auth::user()->role_id == 1)
                            ...
                            <a href="/categories" @if(request()->route()->uri ==  'categories' || request()->route()->uri == 'category-add' || request()->route()->uri == 'category-edit/{slug}' || request()->route()->uri == 'category-delete/{slug}' ) class="active" @endif>Categories</a>
                        ...
                        @else
                            ...
                            <a href="/bookList"@if(request()->route()->uri ==  'bookList') class="active"@endif>Book List</a>
                            <a href="/">LogOut</a>
                        @endif                    
                    {{-- @else
